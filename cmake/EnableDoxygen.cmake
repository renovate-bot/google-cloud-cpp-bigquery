...
if (${CMAKE_VERSION} VERSION_LESS "3.9")
    ...
    if (Doxygen_FOUND)
        ...
        set(DOXYGEN_EXCLUDE_SYMBOLS "internal" "bigquery_testing")
        set(DOXYGEN_PREDEFINED
            "BIGQUERY_CLIENT_NS=v${BIGQUERY_CLIENT_VERSION_MAJOR}")
        set(DOXYGEN_EXCLUDE_PATTERNS
            "*/google/cloud/bigquery/README.md"
            "*/google/cloud/bigquery/internal/*"
            "*/google/cloud/bigquery/testing/*"
            "*/google/cloud/bigquery/*_test.cc")
